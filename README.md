...
| 压缩包 | 给谁使用 | 作用 |
|---|---|---|
| `china-payroll-workflow-universal-v1.1.1.zip`（通用版） | 领导、财务人员 | 解压后双击 `打开工资表工具.html`，生成待复核工资表 |
| `china-payroll-workflow-maintenance-v1.1.1.zip`（维护版） | 领导电脑上的 Codex 或开发人员 | 包含源码、合成测试、规则说明和重新打包工具，用于维护或增加表单适配 |
...
2. 双击 `打开工资表工具.html`；
3. 选择上月已经确认的完整工资表；
4. 选择目标月份的个税、社保、公积金及其他必要附件；
5. 输入人员、工资、考勤、绩效、提成或已验证业务 Excel/Word 中的目标月变化；
